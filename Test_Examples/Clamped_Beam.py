# -*- coding: utf-8 -*-
"""
Created on Fri Feb 19 16:04:08 2021
...
force = [-4e7,9,2] #First magnitude, second marker, third direction
bmarker = [1,4]
...
ep=[2,1,2,False,2]    #ep[ptype, thickness, integration rule(only used for QUAD),linear?,el_type(2-tri,3-quad)]  
SIMP_penal = 3
method='OC'
Debug=False
