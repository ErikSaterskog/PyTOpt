...
## Installation
  ...
  To install the package write: 'pip install git+https://github.com/ErikSaterskog/PyTOpt.git --user' in your terminal. Make sure that setuptools is installed before installing this package.\
 \
